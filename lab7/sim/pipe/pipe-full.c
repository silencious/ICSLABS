...
int gen_f_pc()
{
    return (((((((if_id_curr->icode) == (I_JMP)) & ((if_id_curr->ifun) == 
                (C_LE))) & ((id_ex_curr->icode) == (I_RMMOVL))) & (
            (ex_mem_curr->icode) == (I_MRMOVL))) & !
        (ex_mem_curr->takebranch)) ? (if_id_curr->valp) : (((
            (ex_mem_curr->icode) == (I_JMP)) & !(ex_mem_curr->takebranch))
         & ((id_ex_curr->status) == (STAT_BUB))) ? (ex_mem_curr->vala) : ((
          (id_ex_curr->icode) == (I_RET)) & ((ex_mem_curr->icode) == 
          (I_PUSHL))) ? (mem_wb_next->valm) : (((mem_wb_curr->icode) == 
          (I_RET)) & ((id_ex_curr->status) == (STAT_BUB))) ? 
...
int gen_f_ifun()
{
    return ((imem_error) ? (F_NONE) : ((if_id_next->icode) == (I_MRMOVL))
       ? (C_LE) : (imem_ifun));
}
...
int gen_e_valA()
{
    return ((((((id_ex_curr->srca) == (ex_mem_curr->destm)) & (
              (id_ex_curr->srcb) != (ex_mem_curr->destm))) & (
            (ex_mem_curr->icode) == (I_MRMOVL) || (ex_mem_curr->icode) == 
            (I_POPL) || (ex_mem_curr->icode) == (I_LEAVE))) & (
          (id_ex_curr->icode) == (I_RMMOVL) || (id_ex_curr->icode) == 
          (I_PUSHL))) ? (mem_wb_next->valm) : (id_ex_curr->vala));
}
...
int gen_F_stall()
{
    return (((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
            ...
            (I_PUSHL)))) | ((((if_id_curr->icode) == (I_RET)) | ((
              (id_ex_curr->icode) == (I_RET)) & ((ex_mem_curr->icode) != 
              (I_PUSHL)))) | (((ex_mem_curr->icode) == (I_RET)) & (
            (mem_wb_curr->icode) != (I_PUSHL)))));
}
...
int gen_D_stall()
{
    return ((((id_ex_curr->icode) == (I_MRMOVL) || (id_ex_curr->icode) == 
          ...
          (id_ex_curr->destm) == (id_ex_next->srca) || (id_ex_curr->destm)
           == (id_ex_next->srcb))) & !((((id_ex_next->srca) == 
            (id_ex_curr->destm)) & ((id_ex_next->srcb) != 
            (id_ex_curr->destm))) & ((if_id_curr->icode) == (I_RMMOVL) || 
          (if_id_curr->icode) == (I_PUSHL))));
}

int gen_D_bubble()
{
    return (((((id_ex_curr->icode) == (I_JMP)) & !(ex_mem_next->takebranch)
          ) & !((((id_ex_curr->ifun) == (C_LE)) & ((ex_mem_curr->icode) == 
              (I_RMMOVL))) & ((mem_wb_curr->icode) == (I_MRMOVL)))) | (!(((
